...
void Excersize_2_23(int solution, int answer) //한라대학교 미래모빌리티공학과 김태민
{
    ...
    srand(time(NULL));
    double height = 2.2 + rand() % (9 + 1) - 4;
    double time = 0.3 + rand() % (9 + 1) - 4;
    double spe3 = 0.441 + rand() % (9 + 1) - 4;
    double v1 = 0;
    double v0 = 0;
    double gravitational_acceleration = 9.80;
    double spe5 = 2.16 + rand() % (9 + 1) - 4;
    double y = 0;
    double spe2 = 1.8 + rand() % (9 + 1) - 4;
    double a = 0;
    double c = 0.5 +rand() % (9 + 1) - 4;
    double d = 2.0 + rand() % (9+1) - 4;
    double Δy = 0;
